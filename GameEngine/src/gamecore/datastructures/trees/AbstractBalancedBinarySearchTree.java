...
public abstract class AbstractBalancedBinarySearchTree<T,NODE extends AbstractBinaryTreeNode<T,NODE>> extends AbstractBinarySearchTree<T,NODE>
{
	 ...
	 */
	protected AbstractBalancedBinarySearchTree(Comparator<? super T> cmp)
	{
		super(cmp);
		return;
	}
	 ...
	 */
	protected AbstractBalancedBinarySearchTree(Iterable<? extends T> seed, Comparator<? super T> cmp)
	{
		super(seed,cmp);
		return;
	}
